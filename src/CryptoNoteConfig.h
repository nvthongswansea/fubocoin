...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(1850000000000000);
...
const char     CRYPTONOTE_NAME[]                             = "fubocoin";
...
const int      P2P_DEFAULT_PORT                              =  34671;
const int      RPC_DEFAULT_PORT                              =  34672;
...
const char* const SEED_NODES[] = { "108.61.201.229:34671", "45.77.131.10:34671" };
